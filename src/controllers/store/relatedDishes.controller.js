...
let jsPath = 'relatedDishes'

const relatedDishListView = async (req, res) => {
  try {
    res.render('store/partials/index', {
      // View
      content: 'relatedDishes/index',
      jsPath,
      // Ultils
      messageJapan,
    })
...
const relatedDishCreateView = async (req, res) => {
  try {
    res.render('store/partials/index', {
      // View
      content: 'relatedDishes/create',
      jsPath,
      // Ultils
      messageJapan,
    })
